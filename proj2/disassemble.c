...
void disassemble(inst_t inst)
{
  ...
  case 0x4:
    printf("beq\t$%d,$%d,%d\n", inst.itype.rs, inst.itype.rt, 4 * se(inst.itype.imm));
    break;
  case 0x5:
    printf("bne\t$%d,$%d,%d\n", inst.itype.rs, inst.itype.rt, 4 * se(inst.itype.imm));
    break;
  case 0x9:
    printf("addiu\t$%d,$%d,%d\n", inst.itype.rt, inst.itype.rs, se(inst.itype.imm));
    break;
  case 0xa:
    printf("slti\t$%d,$%d,%d\n", inst.itype.rt, inst.itype.rs, se(inst.itype.imm));
    break;
  ...
  case 0xf: 
    ...
    break;
  case 0x20:
    printf("lb\t$%d,%d($%d)\n", inst.itype.rt, se(inst.itype.imm), inst.itype.rs);
    break;
  case 0x21:
    printf("lh\t$%d,%d($%d)\n", inst.itype.rt, se(inst.itype.imm), inst.itype.rs);
    break;
